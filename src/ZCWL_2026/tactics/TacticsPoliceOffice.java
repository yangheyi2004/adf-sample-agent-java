...
public class TacticsPoliceOffice extends adf.core.component.tactics.TacticsPoliceOffice {
        ...
        switch (scenarioInfo.getMode()) {
            ...
            case NON_PRECOMPUTE:
                this.allocator = moduleManager.getModule(
                    ...
                    "ZCWL_2026.module.complex.PoliceTargetAllocator");
                this.picker = moduleManager.getCommandPicker(
                    "TacticsPoliceOffice.CommandPicker",
                    "ZCWL_2026.centralized.PoliceCommandPicker");
                break;
        }
