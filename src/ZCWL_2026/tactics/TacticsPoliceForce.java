...
public class TacticsPoliceForce extends adf.core.component.tactics.TacticsPoliceForce {
        ...
        switch (scenarioInfo.getMode()) {
            ...
            case NON_PRECOMPUTE:
                ...
                this.actionExtClear = moduleManager.getExtAction(
                    ...
                    "ZCWL_2026.extraction.PoliceExtAction");
    ...
    private void sendActionMessage(WorldInfo worldInfo, MessageManager messageManager,
