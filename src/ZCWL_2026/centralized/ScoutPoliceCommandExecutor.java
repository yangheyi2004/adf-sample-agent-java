...
public class ScoutPoliceCommandExecutor extends adf.core.component.centralized.CommandExecutor {
    ...
    public ScoutPoliceCommandExecutor(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("ScoutPoliceCommandExecutor.PathPlanning", "ZCWL_2026.module.algorithm.PathPlanning");
                this.actionExtClear = moduleManager.getExtAction("ScoutPoliceCommandExecutor.ActionExtClear", "ZCWL_2026.extraction.ActionExtClear");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("ScoutPoliceCommandExecutor.PathPlanning", "ZCWL_2026.module.algorithm.PathPlanning");
                this.actionExtClear = moduleManager.getExtAction("ScoutPoliceCommandExecutor.ActionExtClear", "ZCWL_2026.extraction.ActionExtClear");
