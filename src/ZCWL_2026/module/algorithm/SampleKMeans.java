...
public class SampleKMeans extends adf.core.component.module.algorithm.Clustering {
    ...
    public SampleKMeans(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.repeatPrecompute = developData.getInteger("ZCWL_2026.module.SampleKMeans.repeatPrecompute", 7);
        this.repeatPreparate = developData.getInteger("ZCWL_2026.module.SampleKMeans.repeatPreparate", 30);
        ...
        this.assignAgentsFlag = developData.getBoolean("ZCWL_2026.module.SampleKMeans.assignAgentsFlag", true);
