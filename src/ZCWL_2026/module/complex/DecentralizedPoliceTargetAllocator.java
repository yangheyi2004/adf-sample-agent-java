...
public class DecentralizedPoliceTargetAllocator extends PoliceTargetAllocator
{
    public DecentralizedPoliceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
