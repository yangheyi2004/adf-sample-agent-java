                    ...
                    ModuleManager moduleManager, DevelopData developData)
    {
        ...
        switch (si.getMode())
        {
            case PRECOMPUTATION_PHASE:
                ...
                {
                    this.pathPlanning = moduleManager.getModule("MySearch.PathPlanning.Ambulance", "ZCWL_2026.module.algorithm.AmbulancePathPlanning");
                    this.clustering = moduleManager.getModule("MySearch.Clustering.Ambulance", "ZCWL_2026.module.algorithm.AmbulanceClustering");
                }
                else if (agentURN == FIRE_BRIGADE)
                {
                    this.pathPlanning = moduleManager.getModule("MySearch.PathPlanning.Fire", "ZCWL_2026.module.algorithm.FirePathPlanning");
                    this.clustering = moduleManager.getModule("MySearch.Clustering.Fire", "ZCWL_2026.module.algorithm.FireClustering");
                }
                else if (agentURN == POLICE_FORCE)
                {
                    this.pathPlanning = moduleManager.getModule("MySearch.PathPlanning.Police", "ZCWL_2026.module.algorithm.PolicePathPlanning");
                    this.clustering = moduleManager.getModule("MySearch.Clustering.Police", "ZCWL_2026.module.algorithm.PoliceClustering");
                }
                break;
            case PRECOMPUTED:
                if (agentURN == AMBULANCE_TEAM)
